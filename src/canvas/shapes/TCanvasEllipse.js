(function (t) {
	...
	t.Class.define('t.canvas.shapes.ellipse',{
		
		Extend : t.canvas.shape,
		
		init : function (options) {
			this.defaultOptions = t.canvas.shapes.ellipse.options;
	...
	t.canvas.shapes.ellipse.options = t.combine (t.canvas.shape.options, {
		xRadius: 20,
		yRadius: 10,
		start: 0,
		end : 360
