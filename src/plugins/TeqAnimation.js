...
(function (t,window) {
	...
	window.t.animation = TeqAnimation;
	window.t.requestAnimFrame = requestAnimFrame;
	window.t.animation.easingList = {
	...
	t.animation.easingList.easeOutBounce = function (t, b, c, d) {
		if ((t/=d) < (1/2.75)) {
	...
	t.animation.easingList.easeInBounce = function (t, b, c, d) {
		return c - window.t.animation.easingList.easeOutBounce(d-t, 0, c, d) + b;
	};
	t.animation.easingList.easeInOutBounce = function (t, b, c, d) {
		if (t < d/2){
			return window.t.animation.easingList.easeInBounce (t*2, 0, c, d) * .5 + b;
		} 
		else{
			return window.t.animation.easingList.easeOutBounce (t*2-d, 0, c, d) * .5 + c*.5 + b;
		}
	};
